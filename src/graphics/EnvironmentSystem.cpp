...
std::array<EnvironmentProfile, 4> EnvironmentSystem::defaults() {
    return {{
        ...
        {
            .skyTop = {43, 128, 190, 255},
            .skyHorizon = {122, 184, 194, 255},
            .lowerSky = {76, 145, 164, 255},
            .fogColor = {104, 137, 145, 255},
            .celestialDirection = {0.62F, 0.68F, 0.39F},
            .celestialColor = {1.0F, 0.86F, 0.56F},
            .sunColor = {1.0F, 0.82F, 0.58F},
            .skyAmbientColor = {0.50F, 0.64F, 0.77F},
            .groundAmbientColor = {0.15F, 0.20F, 0.22F},
        ...
        },
        {
            ...
            .fogColor = {158, 86, 75, 255},
            .celestialDirection = {0.84F, 0.28F, 0.35F},
            .celestialColor = {1.0F, 0.47F, 0.2F},
            .sunColor = {1.0F, 0.43F, 0.20F},
            .skyAmbientColor = {0.48F, 0.46F, 0.65F},
            .groundAmbientColor = {0.16F, 0.17F, 0.25F},
