    ...
    return {{
        {
            ...
            .fogColor = {190, 154, 132, 255},
            .celestialDirection = {-0.76F, 0.18F, -0.24F},
            .celestialColor = {1.0F, 0.64F, 0.38F},
            .sunColor = {1.0F, 0.66F, 0.42F},
            .skyAmbientColor = {0.72F, 0.79F, 0.91F},
            .groundAmbientColor = {0.31F, 0.35F, 0.38F},
            .dayNightTint = {1.0F, 0.93F, 0.88F},
            .sunIntensity = 0.84F,
        ...
        },
        {
            ...
            .fogColor = {171, 195, 197, 255},
            .celestialDirection = {0.42F, 0.86F, 0.28F},
            .celestialColor = {1.0F, 0.83F, 0.52F},
            .sunColor = {1.0F, 0.91F, 0.78F},
            .skyAmbientColor = {0.78F, 0.87F, 0.96F},
            .groundAmbientColor = {0.34F, 0.4F, 0.4F},
            .dayNightTint = {1.0F, 0.99F, 0.95F},
            .sunIntensity = 0.91F,
        ...
        },
        {
            ...
            .fogColor = {178, 124, 105, 255},
            .celestialDirection = {0.88F, 0.12F, 0.26F},
            .celestialColor = {1.0F, 0.47F, 0.2F},
            .sunColor = {1.0F, 0.47F, 0.25F},
            .skyAmbientColor = {0.68F, 0.68F, 0.82F},
            .groundAmbientColor = {0.3F, 0.31F, 0.38F},
            .dayNightTint = {1.0F, 0.87F, 0.8F},
            .sunIntensity = 0.78F,
            .ambientIntensity = 0.55F,
            .fogStart = 23.0F,
            .fogEnd = 76.0F,
        ...
        },
        {
            ...
            .skyAmbientColor = {0.4F, 0.51F, 0.72F},
            .groundAmbientColor = {0.2F, 0.28F, 0.38F},
