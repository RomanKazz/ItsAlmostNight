...
std::array<EnvironmentProfile, 4> EnvironmentSystem::defaults() {
    return {{
        {
            .skyTop = {93, 83, 139, 255},
            .skyHorizon = {246, 151, 91, 255},
            .lowerSky = {112, 78, 76, 255},
            .fogColor = {246, 151, 91, 255},
        ...
        {
            .skyTop = {111, 167, 207, 255},
            .skyHorizon = {192, 213, 213, 255},
            .lowerSky = {163, 193, 197, 255},
            .fogColor = {192, 213, 213, 255},
        ...
        {
            .skyTop = {91, 67, 122, 255},
            .skyHorizon = {239, 125, 74, 255},
            .lowerSky = {105, 66, 66, 255},
            .fogColor = {239, 125, 74, 255},
        ...
        {
            .skyTop = {6, 10, 25, 255},
            .skyHorizon = {29, 43, 70, 255},
            .lowerSky = {13, 22, 38, 255},
            .fogColor = {29, 43, 70, 255},
            ...
            .groundAmbientColor = {0.13F, 0.2F, 0.25F},
            .dayNightTint = {0.68F, 0.78F, 1.0F},
            .sunIntensity = 0.57F,
